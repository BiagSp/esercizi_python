"""
Create a finance tracker with plot income and expanse
...
def main():
    while True:
        ...
        print("3. Exit")
        choice = input("Ener your choice (1-3):\n")
        ...
        if choice == "1":
            ...
            if input("Do you want to see a plot? (y/n):\n").lower() == "y":
                plot_transaction(df)
        elif choice == "3":
            print("Exiting...")
            break
        else:
            print("Invalis choice. Enter 1, 2, 3")
