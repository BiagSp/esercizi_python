...
%Primo Capitolo
\include{capitoli/capitoloI(intro)}


%Capitolo 2 Introduzione alle variabili in Python
\include{capitoli/capitoloII(Variabili)}


%Sottocapitolo degli Operatori
\include{capitoli/Operatori}


%Capitolo Approfondimento delle Variabili
\include{capitoli/ApprofondimentoVariabili}


%Fine Capitolo 2 Esercizi
\include{capitoli/eserciziPrimoIcapitolo}


%Capitolo III Liste Tuple Set
\include{capitoli/CapitoloIIIListe}
%Sottocapitolo Sintassi Base best Practice per denominazione
\include{capitoli/SintassiBaseListe}
%Sottocapitolo Operazioni e metodi per le Liste
\include{capitoli/operazioniMetodiListe}
%Sottocapitolo Comportamento liste in Memoria
\include{capitoli/comportamentoListeinMemoria}

%Sezione per Esercizi Sulle Liste
\include{capitoli/eserciziPerListe}
%Sezione III.2 TUPLE
\include{capitoli/CapitoloIII.2Tuple}


%Sezione Dizionari
\include{capitoli/CapitoloDizionari}

%Sezione Set
\include{capitoli/CapitoloSet}
